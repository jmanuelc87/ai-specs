Please analyze and fix the Issue ticket: $ARGUMENTS.
...
7. Push and create a PR, using the ID of the ticket (for example SCRUM-1)

Remember to use the git (`git`) for all Github-related tasks
